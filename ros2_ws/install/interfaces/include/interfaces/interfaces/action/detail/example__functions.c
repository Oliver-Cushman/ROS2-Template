...
interfaces__action__Example_Goal__create()
{
  ...
  interfaces__action__Example_Goal * msg = (interfaces__action__Example_Goal *)allocator.allocate(sizeof(interfaces__action__Example_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_Goal__Sequence__init(interfaces__action__Example_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_Goal *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_Goal__Sequence * array = (interfaces__action__Example_Goal__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_Goal__Sequence__are_equal(const interfaces__action__Example_Goal__Sequence * lhs, const interfaces__action__Example_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_Goal * data =
      (interfaces__action__Example_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_Result * msg = (interfaces__action__Example_Result *)allocator.allocate(sizeof(interfaces__action__Example_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_Result__Sequence__init(interfaces__action__Example_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_Result *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_Result__Sequence * array = (interfaces__action__Example_Result__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_Result__Sequence__are_equal(const interfaces__action__Example_Result__Sequence * lhs, const interfaces__action__Example_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_Result * data =
      (interfaces__action__Example_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_Feedback * msg = (interfaces__action__Example_Feedback *)allocator.allocate(sizeof(interfaces__action__Example_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_Feedback__Sequence__init(interfaces__action__Example_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_Feedback *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_Feedback__Sequence * array = (interfaces__action__Example_Feedback__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_Feedback__Sequence__are_equal(const interfaces__action__Example_Feedback__Sequence * lhs, const interfaces__action__Example_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_Feedback * data =
      (interfaces__action__Example_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
interfaces__action__Example_SendGoal_Request__are_equal(const interfaces__action__Example_SendGoal_Request * lhs, const interfaces__action__Example_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!interfaces__action__Example_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_SendGoal_Request * msg = (interfaces__action__Example_SendGoal_Request *)allocator.allocate(sizeof(interfaces__action__Example_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_SendGoal_Request__Sequence__init(interfaces__action__Example_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_SendGoal_Request *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_SendGoal_Request__Sequence * array = (interfaces__action__Example_SendGoal_Request__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_SendGoal_Request__Sequence__are_equal(const interfaces__action__Example_SendGoal_Request__Sequence * lhs, const interfaces__action__Example_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_SendGoal_Request * data =
      (interfaces__action__Example_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_SendGoal_Response * msg = (interfaces__action__Example_SendGoal_Response *)allocator.allocate(sizeof(interfaces__action__Example_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_SendGoal_Response__Sequence__init(interfaces__action__Example_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_SendGoal_Response *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_SendGoal_Response__Sequence * array = (interfaces__action__Example_SendGoal_Response__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_SendGoal_Response__Sequence__are_equal(const interfaces__action__Example_SendGoal_Response__Sequence * lhs, const interfaces__action__Example_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_SendGoal_Response * data =
      (interfaces__action__Example_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_GetResult_Request * msg = (interfaces__action__Example_GetResult_Request *)allocator.allocate(sizeof(interfaces__action__Example_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_GetResult_Request__Sequence__init(interfaces__action__Example_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_GetResult_Request *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_GetResult_Request__Sequence * array = (interfaces__action__Example_GetResult_Request__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_GetResult_Request__Sequence__are_equal(const interfaces__action__Example_GetResult_Request__Sequence * lhs, const interfaces__action__Example_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_GetResult_Request * data =
      (interfaces__action__Example_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
interfaces__action__Example_GetResult_Response__are_equal(const interfaces__action__Example_GetResult_Response * lhs, const interfaces__action__Example_GetResult_Response * rhs)
{
  ...
  // result
  if (!interfaces__action__Example_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_GetResult_Response * msg = (interfaces__action__Example_GetResult_Response *)allocator.allocate(sizeof(interfaces__action__Example_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_GetResult_Response__Sequence__init(interfaces__action__Example_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_GetResult_Response *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_GetResult_Response__Sequence * array = (interfaces__action__Example_GetResult_Response__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_GetResult_Response__Sequence__are_equal(const interfaces__action__Example_GetResult_Response__Sequence * lhs, const interfaces__action__Example_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_GetResult_Response * data =
      (interfaces__action__Example_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
interfaces__action__Example_FeedbackMessage__are_equal(const interfaces__action__Example_FeedbackMessage * lhs, const interfaces__action__Example_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!interfaces__action__Example_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_FeedbackMessage * msg = (interfaces__action__Example_FeedbackMessage *)allocator.allocate(sizeof(interfaces__action__Example_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__action__Example_FeedbackMessage__Sequence__init(interfaces__action__Example_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__action__Example_FeedbackMessage *)allocator.zero_allocate(size, sizeof(interfaces__action__Example_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__action__Example_FeedbackMessage__Sequence * array = (interfaces__action__Example_FeedbackMessage__Sequence *)allocator.allocate(sizeof(interfaces__action__Example_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
interfaces__action__Example_FeedbackMessage__Sequence__are_equal(const interfaces__action__Example_FeedbackMessage__Sequence * lhs, const interfaces__action__Example_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__action__Example_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__action__Example_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__action__Example_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__action__Example_FeedbackMessage * data =
      (interfaces__action__Example_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__action__Example_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__action__Example_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__action__Example_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
