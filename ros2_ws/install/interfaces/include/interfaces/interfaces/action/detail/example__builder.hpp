...
class Init_Example_Goal_input
{
public:
  Init_Example_Goal_input()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::interfaces::action::Example_Goal input(::interfaces::action::Example_Goal::_input_type arg)
  {
...
{
  return interfaces::action::builder::Init_Example_Goal_input();
}
...
class Init_Example_Result_output
{
public:
  Init_Example_Result_output()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::interfaces::action::Example_Result output(::interfaces::action::Example_Result::_output_type arg)
  {
...
{
  return interfaces::action::builder::Init_Example_Result_output();
}
...
class Init_Example_Feedback_feedback
{
public:
  Init_Example_Feedback_feedback()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::interfaces::action::Example_Feedback feedback(::interfaces::action::Example_Feedback::_feedback_type arg)
  {
...
{
  return interfaces::action::builder::Init_Example_Feedback_feedback();
}
