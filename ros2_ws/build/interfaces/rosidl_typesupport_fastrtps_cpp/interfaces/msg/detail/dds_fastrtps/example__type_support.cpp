...
#include "interfaces/msg/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Example & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Example & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Example;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Example *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Example *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Example__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Example)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Example__handle;
}
