...
#ifndef INTERFACES__MSG__DETAIL__EXAMPLE__TRAITS_HPP_
#define INTERFACES__MSG__DETAIL__EXAMPLE__TRAITS_HPP_
...
inline void to_yaml(
  const interfaces::msg::Example & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const interfaces::msg::Example & msg)
{
...
template<>
inline const char * name<interfaces::msg::Example>()
{
  return "interfaces/msg/Example";
}
...
#endif  // INTERFACES__MSG__DETAIL__EXAMPLE__TRAITS_HPP_
