...
#include "interfaces/srv/detail/example__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__srv__Example_Request;
    is_plain =
      (
...
static size_t _Example_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__Example_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__srv__Example_Response;
    is_plain =
      (
...
static size_t _Example_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__Example_Response(
    full_bounded, is_plain, 0);
