...
#include "interfaces/action/detail/example__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__action__Example_Goal;
    is_plain =
      (
...
static size_t _Example_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_Result;
    is_plain =
      (
...
static size_t _Example_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_Feedback;
    is_plain =
      (
...
static size_t _Example_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_Feedback(
    full_bounded, is_plain, 0);
...
// already included above
// #include "interfaces/action/detail/example__functions.h"  // goal
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, action, Example_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_SendGoal_Request;
    is_plain =
      (
...
static size_t _Example_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_SendGoal_Response;
    is_plain =
      (
...
static size_t _Example_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_GetResult_Request;
    is_plain =
      (
...
static size_t _Example_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_GetResult_Request(
    full_bounded, is_plain, 0);
...
// already included above
// #include "interfaces/action/detail/example__functions.h"  // result
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, action, Example_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_GetResult_Response;
    is_plain =
      (
...
static size_t _Example_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_GetResult_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "interfaces/action/detail/example__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, action, Example_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Example_FeedbackMessage;
    is_plain =
      (
      offsetof(DataType, feedback) +
      last_member_size
...
static size_t _Example_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Example_FeedbackMessage(
    full_bounded, is_plain, 0);
